...
<body style="background-color: #23272A;">
    <h1 style="font-size: 45px;color: #FFFFFF;">Crafting Table BOT Webpage overview</h1><button class="btn btn-primary text-center text-sm-center text-md-center text-lg-center text-xl-center" data-bs-hover-animate="pulse" type="button" style="background-image: url(&quot;/assets/img/Discord-Logo+Wordmark-White.png?h=d546a1986006a42b59818f25cc8d8a03&quot;);width: 816px;height: 251px;font-size: 50px;color: #2C2F33;align-items: center;align-content: center;align-self: center;background-color: #7289DA;"><br></button>
    <h1
        class="text-left" style="color: #FFFFFF;"><br><strong>Login with Discord</strong><br><br></h1>
